    ...
    .controller('mainCtrl', function($scope, $timeout, $rootScope) {
         ...
         $scope.setDiagramGroup = function(newIndex, oldIndex) {
            ...
            if (newIndex === $scope.showGroupIndex) { // is the tab already open?
                ...
                $scope.templates = [
                    ...
                    {name:'AWS Architecture', preview:'images/shapeLibrary/aws-44px.png', recommended: 'false', example1:'images/examples/aws1.png', example2:'images/examples/aws2.png', example2:'images/examples/aws3.png', details: 'Accurately diagram AWS architecture with the official AWS Simple Icons. You can chart with network shapes, database symbols, and a variety of other Amazon Web Services elements.'},
                    {name:'Azure', preview:'images/shapeLibrary/azure-44px.png', recommended: 'false'},
                    {name:'BPMN 2.0', preview:'images/shapeLibrary/bpmn-44px.png', recommended: 'false'},
                    {name:'Circuit Diagrams', preview:'images/shapeLibrary/circuit-44px.png', recommended: 'false'},
                    {name:'Cisco Network', preview:'images/shapeLibrary/cisco-44px.png', recommended: 'false'},
                    {name:'Data Flow', preview:'images/shapeLibrary/data-flow-44px.png', recommended: 'false'},
                    {name:'Enterprise Integration', preview:'images/shapeLibrary/enterprise-int-44px.png', recommended: 'false'},
                    {name:'Entity Relationship', preview:'images/shapeLibrary/erd-44px.png', recommended: 'false'},
                    {name:'Equations', preview:'images/shapeLibrary/equations-44px.png', recommended: 'false'},
                    {name:'Flowchart', preview:'images/shapeLibrary/flowchart-44px.png', recommended: 'false'},
                    {name:'Floorplans', preview:'images/shapeLibrary/floorplans-44px.png', recommended: 'false'},
                    {name:'iOS Mockups', preview: 'images/shapeLibrary/ios-44px.png', recommended: 'false'},
                    {name:'Mind Mapping', preview:'images/shapeLibrary/mind-map-44px.png', recommended: 'false'},
                    {name:'Network Infrastructure', preview:'images/shapeLibrary/network-44px.png', recommended: 'false'},
                    {name:'Org Charts', preview:'images/shapeLibrary/org-chart-44px.png', recommended: 'false'},
                    {name:'Process Engineering', preview:'images/shapeLibrary/process-eng-44px.png', recommended: 'false'},
                    {name:'Server Rack Diagrams', preview:'images/shapeLibrary/server-rack-44px.png', recommended: 'false'},
                    {name:'Site Maps', preview:'images/shapeLibrary/site-maps-44px.png', recommended: 'false'},
                    {name:'Tables', preview: 'images/shapeLibrary/tables-44px.png', recommended: 'false'},
                    {name:'Timeline', preview:'images/shapeLibrary/tech-clipart-44px.png', recommended: 'false'},
                    {name:'Tech Clipart', preview:'images/shapeLibrary/tech-clipart-44px.png', recommended: 'false'},
                    {name:'UI Mockups', preview:'images/shapeLibrary/ui-44px.png', recommended: 'false'},
                    {name:'UML', preview:'images/shapeLibrary/uml-44px.png', recommended: 'false'},
                    {name:'Value Stream', preview: 'images/shapeLibrary/value-stream-44px.png', recommended: 'false'},
                    {name:'Venn Diagrams', preview:'images/shapeLibrary/venn-diagrams.png', recommended: 'false'},
                    {name:'Video', preview:'images/shapeLibrary/videos-44px.png', recommended: 'false'},        
                ];
        ...
        $scope.getDiagrams = function(string1, string2){
            ...
            if(string2=='design'){
                ...
                $scope.templates = [
                    {name:'Android Mockups', preview:'images/shapeLibrary/android-44px.png', recommended: 'true'},
                    {name:'Floorplans', preview:'images/shapeLibrary/floorplans-44px.png', recommended: 'true'},
                    {name:'iOS Mockups', preview: 'images/shapeLibrary/ios-44px.png', recommended: 'true'},
                    {name:'UI Mockups', preview:'images/shapeLibrary/ui-44px.png', recommended: 'true'},
                    {name:'Tech Clipart', preview:'images/shapeLibrary/tech-clipart-44px.png', recommended: 'true'},
                    {name:'Flowchart', preview:'images/shapeLibrary/flowchart-44px.png', recommended: 'true'},

                    {name:'AWS Architecture', preview:'images/shapeLibrary/aws-44px.png', recommended: 'false'},
                    {name:'Azure', preview:'images/shapeLibrary/azure-44px.png', recommended: 'false'},
                    {name:'BPMN 2.0', preview:'images/shapeLibrary/bpmn-44px.png', recommended: 'false'},
                    {name:'Circuit Diagrams', preview:'images/shapeLibrary/circuit-44px.png', recommended: 'false'},
                    {name:'Cisco Network', preview:'images/shapeLibrary/cisco-44px.png', recommended: 'false'},
                ...
                $scope.templates = [
                    {name:'Mind Mapping', preview:'images/shapeLibrary/mind-map-44px.png', recommended: 'true'},
                    {name:'Tables', preview: 'images/shapeLibrary/tables-44px.png', recommended: 'true'},
                    {name:'Flowchart', preview:'images/shapeLibrary/flowchart-44px.png', recommended: 'true'},
                    {name:'Venn Diagrams', preview:'images/shapeLibrary/venn-diagrams.png', recommended: 'true'},

                    {name:'Android Mockups', preview:'images/shapeLibrary/android-44px.png', recommended: 'false'},
                    {name:'AWS Architecture', preview:'images/shapeLibrary/aws-44px.png', recommended: 'false'},
                    {name:'Azure', preview:'images/shapeLibrary/azure-44px.png', recommended: 'false'},
                    {name:'BPMN 2.0', preview:'images/shapeLibrary/bpmn-44px.png', recommended: 'false'},
                    {name:'Circuit Diagrams', preview:'images/shapeLibrary/circuit-44px.png', recommended: 'false'},
                ...
                $scope.templates = [
                    {name:'AWS Architecture', preview:'images/shapeLibrary/aws-44px.png', recommended: 'true'},
                    {name:'Circuit Diagrams', preview:'images/shapeLibrary/circuit-44px.png', recommended: 'true'},
                    {name:'Cisco Network', preview:'images/shapeLibrary/cisco-44px.png', recommended: 'true'},
                    {name:'Network Infrastructure', preview:'images/shapeLibrary/network-44px.png', recommended: 'true'},
                    {name:'Android Mockups', preview:'images/shapeLibrary/android-44px.png', recommended: 'true'},
                    {name:'Server Rack Diagrams', preview:'images/shapeLibrary/server-rack-44px.png', recommended: 'true'},
                    {name:'Site Maps', preview:'images/shapeLibrary/site-maps-44px.png', recommended: 'true'},
                ...
                $scope.templates = [
                    {name:'BPMN 2.0', preview:'images/shapeLibrary/bpmn-44px.png', recommended: 'true'},
                    {name:'Data Flow', preview:'images/shapeLibrary/data-flow-44px.png', recommended: 'true'},
                    {name:'Entity Relationship', preview:'images/shapeLibrary/erd-44px.png', recommended: 'true'},
                    {name:'Flowchart', preview:'images/shapeLibrary/flowchart-44px.png', recommended: 'true'},
                    {name:'Network Infrastructure', preview:'images/shapeLibrary/network-44px.png', recommended: 'true'},
                    {name:'Org Charts', preview:'images/shapeLibrary/org-chart-44px.png', recommended: 'true'},
