/* global angular, cordova, StatusBar, console*/
...
.run(['$ionicPlatform', function($ionicPlatform) {
    ...
    .config(['$stateProvider', '$urlRouterProvider', '$sceDelegateProvider', '$ionicConfigProvider', function($stateProvider, $urlRouterProvider, $sceDelegateProvider, $ionicConfigProvider) {
